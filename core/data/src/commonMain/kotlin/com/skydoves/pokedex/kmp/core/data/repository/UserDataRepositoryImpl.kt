...
import com.skydoves.pokedex.kmp.core.datastore.PreferencesDataSource
...
public class UserDataRepositoryImpl(private val preferencesDataSource: PreferencesDataSource) :
  UserDataRepository {

  override val userData: Flow<UserData> = preferencesDataSource.userData.flowOn(ioDispatcher)
